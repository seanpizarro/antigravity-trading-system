    ...
    def execute_trade(self, opportunity, account_type: str = 'paper') -> Dict:
        ...
        try:
            ...
            if account.is_paper:
                ...
                # Use live trading method (commented for safety)
                # result = account.api_instance.execute_trade(opportunity)
                result = {'success': False, 'error': 'Live trading disabled for safety'}
                self.logger.warning("⚠️ Live trading execution disabled")
