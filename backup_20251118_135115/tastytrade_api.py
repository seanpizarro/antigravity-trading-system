...
class TastyTradeAPI:
    ...
    def _get_mock_account_data(self) -> Dict:
        ...
        return {
            "data": {
                ...
                "derivative-buying-power": 50000.00,
    ...
    # close_position, roll_position, adjust_position, etc.
    # These will automatically work with sandbox mode due to _make_request updates
